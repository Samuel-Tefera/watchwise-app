...
export default function NavBar() {
  ...
  return (
    <nav className="bg-dark border-b border-stone-800 fixed top-0 w-full flex items-center justify-between py-4 px-4 sm:px-12 lg:px-24 z-50">
      <Link
        to="/"
      ...
      <ul className="hidden lg:flex gap-5 items-center font-semibold text-primary text-lg xl:text-xl uppercase">
        <li>
          <Link
            to="/discover"
      ...
      {isMenuOpen && (
        <div className="lg:hidden absolute top-full left-0 right-0 bg-dark border-t border-stone-800 py-4 px-6">
